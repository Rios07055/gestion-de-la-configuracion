...
class Game(object):
    ...
    def __init__(self, ancho_juego, alto_juego):
        ...
        self.fondo = pygame.image.load('fondito Snake game 2.0.jpg')
        self.colision = False
        self.score = 0
...
class Player(object):
    ...
    def __init__(self):
        ...
        self.n_fresas = 1
        self.comida = False
        self.imagen = pygame.image.load('cuerpo_serpiente.jpg')
        self.cambio_x = 20
        self.cambio_y = 0
        self.direccion = [1, 0]
    ...
    def refrescar_posicion(self, x, y):
        if self.posicion[-1][0] != x or self.posicion[-1][0] != y:
            if self.n_fresas > 1:
                for i in range(self.n_fresas - 1):
...
class Food(object):
    ...
    def __init__(self):
        self.x_food = 200
        self.y_food = 200
        self.imagen = pygame.image.load('Comidas Snake game 2.00.png')
